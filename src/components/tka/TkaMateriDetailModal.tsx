          ...
          {activeTab === 'KONSEP' && (
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-2xl bg-blue-50/80 border border-blue-200/80 space-y-1">
                ...
                <p className="text-xs sm:text-sm text-[#2A4365] leading-relaxed">
                  {lesson.overview}
                </p>
              </div>
                  ...
                  >
                    ...
                    >
                      <div className="space-y-1 min-w-0">
                        ...
                        <p className="text-xs sm:text-sm font-semibold text-[#1F3A5F] leading-snug">
                          {prob.question}
                        </p>
                      </div>
                    ...
                    {isExp && (
                      <div className="px-4 pb-4 pt-2 border-t border-gray-100 space-y-3 bg-[#F8FAFC]">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <div className="space-y-1 pl-1">
                            {prob.stepByStep.map((step, sIdx) => (
                              <p key={sIdx} className="text-xs text-gray-700 leading-relaxed">
                                {step}
                              </p>
                            ))}
                          </div>
                        ...
                        <div className="flex items-center gap-2 pt-1">
                          <span className="text-xs font-bold text-gray-500">Jawaban Akhir:</span>
                          <span className="px-2.5 py-1 rounded-lg bg-emerald-100 text-emerald-800 font-heading font-bold text-xs">
                            {prob.answer}
                          </span>
                        </div>
                      </div>
