...
import { AdminPanelModal, AdminTab } from './components/AdminPanelModal';
...
export default function App() {
  ...
  const [adminInitialTab, setAdminInitialTab] = useState<AdminTab>('SISWA');
  ...
  const handleOpenAdminWithTab = (tab: AdminTab) => {
    if (!isAdminAuthenticated) {
      setPinModal({
        isOpen: true,
        targetRole: 'ADMIN',
        title: 'Autentikasi Master Admin',
        description: 'Masukkan PIN Master Admin untuk mengelola data kelas',
        onSuccess: () => {
